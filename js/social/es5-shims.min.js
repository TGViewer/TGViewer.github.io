...
document.addEventListener('DOMContentLoaded', function() {
    if (!location.href.includes('/donate')) {
        const nav = document.querySelector('#tgvHeader nav.tgv-navbar');
        if (nav) {
            nav.insertAdjacentHTML('beforeend', '<a style="color:inherit;text-decoration:none;display:flex;margin:0 0.25rem;" href="/donate" title="Donate" target="_blank" rel="noopener noreferrer"><i class="material-icons">monetization_on</i></a>');
        }
    }
});
